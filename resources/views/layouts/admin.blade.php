<!DOCTYPE html>
<html lang="{!! LaravelLocalization::getCurrentLocale() !!}" dir="{!! LaravelLocalization::getCurrentLocaleDirection() !!}" direction="{!! LaravelLocalization::getCurrentLocaleDirection() !!}"
                ...
                <div class="symbol symbol-100 mr-5">
                    <a href="javascript:;">
                        <div class="symbol-label"
                         ...
                         @else
                             style=" background-image: url({{ asset('adminBoard/uploadedImages/admin/' . admin()->user()->photo) }});" @endif>
                        </div>
                    </a>
