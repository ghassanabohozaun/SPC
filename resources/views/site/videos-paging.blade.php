                ...
                <div class="col">
                    <a data-fancybox="" data-small-btn="true"
                       href="https://www.youtube.com/watch?v={!! $video->link !!}">
                        <div class="card">
                            <img class="youtube_icon" src="{!! asset('site/assets/images/youtube_icon2.png') !!}"
                                 width="100">
                            <img class="card-img-top img-fluid"
                                 src="{!! $video->photo == null ? 'https://img.youtube.com/vi/WKYGTgsX2Wg/mqdefault.jpg': asset(\Illuminate\Support\Facades\Storage::url($video->photo)) !!} "
                                 alt="{!! Lang()=='ar'?$video->title_ar:$video->title_en !!}">
