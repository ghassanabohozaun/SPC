        ...
        <div class="grid-container grid-x grid-padding-x my_testimonials_section" dir="rtl">
            ...
            <div class="large-9 medium-12 small-12 cell">
                ...
                <div class="testimonial_list" id="testimonial_list">
                    @include('site.testimonial-paging')
                </div>
            ...
            <div class="large-3 medium-12 small-12 cell">
                ...
                <div class="widget filter_form">
                    <h6>{!! trans('site.filter') !!}</h6>
                    <div class="widget-content">
                        <form>
                            <select id="filter_by_year" class="filter_by_year">
                                <option value="">{!! trans('site.select_year') !!}</option>
                                <?php
                ...
                <!-- Start Form /-->
                <div class="widget">
                    <h6>{!! trans('site.submit_testimonial') !!}</h6>
                    <div class="widget-content">
                        <form id="send_testimonials_form" action="{!! route('send.testimonial') !!}"
                        ...
                        <!------------------------------------------------------------>
                            ...
                            @if(Lang()=='ar')
                                <input type="text" id="client_name_ar" name="client_name_ar"
                                       placeholder="{!! trans('site.your_nickname') !!}" autocomplete="off"/>
                                <span id="client_name_ar_error" class="form-text text-danger"></span>
                            @else
                                <input type="text" id="client_name_en" name="client_name_en"
                                       placeholder="{!! trans('site.your_nickname') !!}" autocomplete="off"/>
                                <span id="client_name_en_error" class="form-text text-danger"></span>
                            @endif
                        <!------------------------------------------------------------>
                            <input type="text" id="client_age" name="client_age"
                                   placeholder="{!! trans('site.your_age') !!}" autocomplete="off"/>
                            <span id="client_age_error" class="form-text text-danger"></span>
                            <!------------------------------------------------------------>
                            <select id="gender" name="gender">
                                <option value="">{!! trans('site.your_gender') !!}</option>
                                <option value="male">{!! trans('site.male') !!}</option>
                                <option value="female">{!! trans('site.female') !!}</option>
                                <option value="others">{!! trans('site.others') !!}</option>
                            </select>
                            <span id="gender_error" class="form-text text-danger"></span>
                            <!------------------------------------------------------------>
                            @if(Lang()=='ar')
                                <input type="text" name="job_title_ar" id="job_title_ar"
                                       placeholder="{!! trans('site.your_job_title') !!}" autocomplete="off"/>
                        ...
                        <!------------------------------------------------------------>
                            <select name="country" id="country">
                                ...
                                <option value='ao' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag ao" data-title="Angola">Angola
                                </option>
                                <option value='aq' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag aq" data-title="Antarctica">Antarctica
                                </option>
                                <option value='ar' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag ar" data-title="Argentina">Argentina
                                </option>
                                <option value='as' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag as" data-title="American Samoa">American Samoa
                                </option>
                                <option value='at' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag at" data-title="Austria">Austria
                                </option>
                                <option value='au' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag au" data-title="Australia">Australia
                                </option>
                                ...
                                <option value='bm' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag bm" data-title="Bermuda">Bermuda
                                </option>
                                <option value='bn' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag bn" data-title="Brunei Darussalam">Brunei Darussalam
                                </option>
                                <option value='bo' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag bo" data-title="Bolivia">Bolivia
                                </option>
                                ...
                                <option value='cc' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag cc" data-title="Cocos (Keeling) Islands">Cocos (Keeling)
                                    Islands
                                </option>
                                <option value='cd' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag cd" data-title="Democratic Republic of the Congo">Democratic
                                    Republic of the Congo
                                </option>
                                <option value='cf' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag cf" data-title="Central African Republic">Central African
                                    Republic
                                </option>
                                ...
                                <option value='ci' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag ci" data-title="Cote D'Ivoire (Ivory Coast)">Cote D'Ivoire
                                    (Ivory Coast)
                                </option>
                                ...
                                <option value='cs' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag cs" data-title="Serbia and Montenegro">Serbia and Montenegro
                                </option>
                                ...
                                <option value='cx' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag cx" data-title="Christmas Island">Christmas Island
                                </option>
                                ...
                                <option value='de' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag de" data-title="Germany">Germany
                                </option>
                                ...
                                <option value='do' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag do" data-title="Dominican Republic">Dominican Republic
                                </option>
                                ...
                                <option value='fk' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag fk" data-title="Falkland Islands (Malvinas)">Falkland
                                    Islands (Malvinas)
                                </option>
                                <option value='fm' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag fm" data-title="Federated States of Micronesia">Federated
                                ...
                                <option value='fx' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag fx" data-title="France, Metropolitan">France, Metropolitan
                                </option>
                                ...
                                <option value='gb' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag gb" data-title="Great Britain (UK)" selected="selected">
                                    Great Britain (UK)
                                </option>
                                ...
                                <option value='gq' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag gq" data-title="Equatorial Guinea">Equatorial Guinea
                                </option>
                                ...
                                <option value='gs' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag gs" data-title="S. Georgia and S. Sandwich Islands">S.
                                ...
                                <option value='hm' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag hm" data-title="Heard Island and McDonald Islands">Heard
                                ...
                                <option value='hr' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag hr" data-title="Croatia (Hrvatska)">Croatia (Hrvatska)
                                </option>
                                ...
                                <option value='io' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag io" data-title="British Indian Ocean Territory">British
                                ...
                                <option value='kn' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag kn" data-title="Saint Kitts and Nevis">Saint Kitts and Nevis
                                </option>
                                ...
                                <option value='mh' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag mh" data-title="Marshall Islands">Marshall Islands
                                </option>
                                ...
                                <option value='mp' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag mp" data-title="Northern Mariana Islands">Northern Mariana
                                    Islands
                                </option>
                                ...
                                <option value='nz' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag nz" data-title="New Zealand (Aotearoa)">New Zealand
                                    (Aotearoa)
                                </option>
                                ...
                                <option value='pf' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag pf" data-title="French Polynesia">French Polynesia
                                </option>
                                <option value='pg' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag pg" data-title="Papua New Guinea">Papua New Guinea
                                </option>
                                ...
                                <option value='pm' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag pm" data-title="Saint Pierre and Miquelon">Saint Pierre and
                                    Miquelon
                                </option>
                                ...
                                <option value='ps' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag ps" data-title="Palestinian Territory">Palestinian Territory
                                </option>
                                ...
                                <option value='ru' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag ru" data-title="Russian Federation">Russian Federation
                                </option>
                                ...
                                <option value='sj' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag sj" data-title="Svalbard and Jan Mayen">Svalbard and Jan
                                    Mayen
                                </option>
                                ...
                                <option value='st' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag st" data-title="Sao Tome and Principe">Sao Tome and Principe
                                </option>
                                ...
                                <option value='tc' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag tc" data-title="Turks and Caicos Islands">Turks and Caicos
                                    Islands
                                </option>
                                ...
                                <option value='tf' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag tf" data-title="French Southern Territories">French Southern
                                    Territories
                                </option>
                                ...
                                <option value='tt' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag tt" data-title="Trinidad and Tobago">Trinidad and Tobago
                                </option>
                                ...
                                <option value='um' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag um" data-title="United States Minor Outlying Islands">United
                                ...
                                <option value='va' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag va" data-title="Vatican City State (Holy See)">Vatican City
                                    State (Holy See)
                                </option>
                                <option value='vc' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag vc" data-title="Saint Vincent and the Grenadines">Saint
                                ...
                                <option value='vg' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag vg" data-title="Virgin Islands (British)">Virgin Islands
                                    (British)
                                </option>
                                <option value='vi' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag vi" data-title="Virgin Islands (U.S.)">Virgin Islands (U.S.)
                                </option>
                                ...
                                <option value='wf' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag wf" data-title="Wallis and Futuna">Wallis and Futuna
                                </option>
                                ...
                                <option value='yu' data-image="images/msdropdown/icons/blank.gif"
                                        data-imagecss="flag yu" data-title="Yugoslavia (former)">Yugoslavia (former)
                                </option>
                            ...
                            <!------------------------------------------------------------>
                            <p class="text-center font-weight-bolder">{!! trans('site.rate_us') !!}</p>
                            <div class="rating my_rating">
                                ...
                                <input checked type="radio" name="rating" value="1" id="1"><label for="1">☆</label>
                            ...
                            <!------------------------------------------------------------>
                            @if(Lang()=='ar')
                                <textarea name="opinion_ar" id="opinion_ar"
                                          placeholder="{!! trans('site.your_reason_of_satisfaction') !!}"
                                          rows="4" autocomplete="off"></textarea>
                                <span id="opinion_ar_error" class="form-text text-danger"></span>
                            @else
                                <textarea name="opinion_en" id="opinion_en"
                                          placeholder="{!! trans('site.your_reason_of_satisfaction') !!}"
                                          rows="4" autocomplete="off"></textarea>
                                <span id="opinion_en_error" class="form-text text-danger"></span>
                        @endif
                        <!------------------------------------------------------------>
                            <label>{!! trans('site.select_your_image') !!}
                            ...
                            <div class="form-group mb-4">
                                <input id="captcha" type="text" class="form-control" placeholder="{!! trans('site.enter_captcha') !!}"
                                       name="captcha">
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $('#send_testimonials_form').validate({
            ...
            messages: {
                client_name_en: {
                    required: '{{trans('site.client_name_required')}}',
                },
                client_name_ar: {
                    required: '{{trans('site.client_name_required')}}',
                },
                client_age: {
                    required: '{{trans('site.client_age_required')}}',
                },
                gender: {
                    required: '{{trans('site.gender_required')}}',
                },

                country: {
                    required: '{{trans('site.country_required')}}',
                },
                rating: {
                    required: '{{trans('site.rating_required')}}',
                },
                opinion_en: {
                    required: '{{trans('site.opinion_required')}}',
                },
                opinion_ar: {
                    required: '{{trans('site.opinion_required')}}',
                },
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        ...
                        swal({
                            icon: "success",
                            text: "{!! trans('site.send_success_message') !!}",
                            buttons: false,
                            timer: 3000,
                        });
