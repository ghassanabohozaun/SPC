                            ...
                            <div class="grid-container grid-x grid-padding-x">
                                ...
                                <div class="medium-12 cell">
                                    <label>
                                        <textarea name="details" id="details"
                                                  autocomplete="off"
                                                  placeholder="{!! trans('site.your_message') !!}"
                                                  rows="6"></textarea>
                                    </label>
                                </div>
                                ...
                                <div class="medium-12 cell">
                                    ...
                                    <button class="primary button"
                                            type="submit">{!! trans('site.book_an_appointment') !!} &nbsp;
                                        <div class="spinner-border  text-info d-none loading_spinner"
                                             id="loading_spinner">
