                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="image-input image-input-outline"
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                    style=";background-image: url({{ asset('adminBoard/uploadedImages/albums/' . $photoAlbum->main_photo) }}">
                                                                </div>
                                                                <label
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="3" class="form-control form-control-solid form-control-lg" name="title_en" id="title_en"
                                                                type="text" placeholder=" {{ __('photoAlbums.enter_title_en') }}" autocomplete="off">{{ $photoAlbum->title_en }}</textarea>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <textarea rows="3" class="form-control form-control-solid form-control-lg" name="title_ar" id="title_ar"
                                                                type="text" placeholder=" {{ __('photoAlbums.enter_title_ar') }}" autocomplete="off">{{ $photoAlbum->title_ar }}</textarea>
