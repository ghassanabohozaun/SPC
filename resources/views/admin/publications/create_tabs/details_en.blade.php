                ...
                <div class="col-xl-9">
                    ...
                    <div class="my-5">
                        ...
                        <div class="form-group">
                            <label>{{ __('publications.title_en') }}</label>
                            <input type="text" class="form-control form-control-solid form-control-lg"
                                name="title_en" id="title_en" placeholder="{{ __('publications.enter_title_en') }}"
                                autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control form-control-solid form-control-lg summernote"
                                placeholder="{{ __('publication.enter_details_en') }}" name="details_en" id="details_en"></textarea>
