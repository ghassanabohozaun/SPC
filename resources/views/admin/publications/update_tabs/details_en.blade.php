                ...
                <div class="col-xl-9">
                    ...
                    <div class="my-5">
                        ...
                        <div class="form-group">
                            <label>
                                {{ __('publications.title_en') }}
                            </label>
                            <input type="text" class="form-control form-control-solid form-control-lg"
                                name="title_en" id="title_en" value="{{ $publication->title_en }}"
                                placeholder="{{ __('publications.enter_title_en') }}" autocomplete="off" readonly>
                        ...
                        <!--begin::Group-->
                        <div class="form-group">
                            <label> {{ __('publications.details_en') }}</label>
                            <textarea class="form-control form-control-solid form-control-lg summernote"
                                placeholder="{{ __('publications.enter_details_en') }}" name="details_en" id="details_en">{{ $publication->details_en }}</textarea>
