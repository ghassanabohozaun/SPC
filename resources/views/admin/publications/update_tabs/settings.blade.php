                            ...
                            <div class="col-lg-9 col-xl-9">
                                <div class="image-input image-input-outline" id="kt_publication_photo">
                                    ...
                                    <div class="image-input-wrapper"
                                        style="background-image: url({{ asset('adminBoard/uploadedImages/publications/' . $publication->photo) }})">
                                    </div>
                                    <label
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <div class="input-group date">
                                    <input type="text" class="form-control form-control-solid form-control-lg"
                                        id="added_date" name="added_date" value="{{ $publication->added_date }}"
                                        readonly placeholder="{{ __('publications.enter_added_date') }}" />
