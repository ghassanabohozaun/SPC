                    ...
                    <div class="my-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-solid form-control-lg"
                                ...
                                placeholder="{{ __('publications.enter_title_ar') }}" autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control form-control-solid form-control-lg summernote"
                                placeholder="{{ __('publications.enter_details_ar') }}" name="details_ar" id="details_ar">{{ $publication->details_ar }}</textarea>
