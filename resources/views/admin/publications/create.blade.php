...
@endsection
@section('content')
    <form class="form" action="{{ route('admin.publications.store') }}" method="POST" id="form_publication_store"
                        ...
                        <div class="card card-custom" id="card_languages">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="publication_settings_tab" data-toggle="tab"
                                            ...
                                            <span class="nav-text">{{ __('publications.publication_settings_tab') }}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="publication_details_en_tab" data-toggle="tab"
                                            href="#publication_details_en" aria-controls="profile">
                                            <span class="nav-icon"><i class="flaticon2-layers-1"></i></span>
                                            <span
                                                class="nav-text">{{ __('publications.publication_details_en_tab') }}</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="publication_details_ar_tab" data-toggle="tab"
                                            href="#publication_details_ar" aria-controls="profile">
                                            <span class="nav-icon"><i class="flaticon2-layers-1"></i></span>
                                            <span
                                                class="nav-text">{{ __('publications.publication_details_ar_tab') }}</span>
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content mt-5">
                                    @include('admin.publications.create_tabs.settings')
                                    @include('admin.publications.create_tabs.details_en')
                                    @include('admin.publications.create_tabs.details_ar')
                                </div>
                            </div>
                        </div>
                        <!--end::Card-->
...
@push('js')
    <script type="text/javascript">
        $('#form_publication_store').on('submit', function(e) {
            e.preventDefault();
                ...
                success: function(data) {
                    ...
                    if (data.status == true) {
                        Swal.fire({
                            ...
                            customClass: {
                                confirmButton: 'add_publication_button'
                            }
                        });
                        $('.add_publication_button').click(function() {
