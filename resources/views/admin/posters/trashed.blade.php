                                        ...
                                        <div class="scroll">
                                            <div class="table-responsive">
                                                <table class="table myTable table-hover" id="myTable">
                                                    ...
                                                    <tbody>
                                                        @forelse($trashedPosters as $poster)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a class="btn btn-hover-warning btn-icon btn-pill restore_poster_btn"
                                                                        data-id="{{ $poster->id }}"
                                                                    ...
                                                                    <a href="#"
                                                                        class="btn btn-hover-danger btn-icon btn-pill force_delete_poster_btn"
                                                                        data-id="{{ $poster->id }}"
                                                        ...
                                                        <tr>
                                                            <td colspan="8">
                                                                <div class="float-right">
                                                                    {!! $trashedPosters->appends(request()->all())->links() !!}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tfoot>
...
@push('js')
    <script type="text/javascript">
        // delete poster
        $(document).on('click', '.force_delete_poster_btn', function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    // Delete User
                    $.ajax({
                        url: "{!! route('admin.posters.force.delete') !!}",
                        data: {
                            id,
                            id
                        },
        ...
        // restore poster
        $(document).on('click', '.restore_poster_btn', function(e) {
            e.preventDefault();
            var id = $(this).data('id');

            $.ajax({
                url: "{{ route('admin.posters.restore') }}",
                data: {
                    id,
                    id
                },
                ...
                success: function(data) {
                    ...
                    if (data.status == true) {
                        Swal.fire({
                            ...
                            allowOutsideClick: false,
                            customClass: {
                                confirmButton: 'restore_poster_button'
                            }
                        });
                        $('.restore_poster_button').click(function() {
                            $('#myTable').load(location.href + (' #myTable'));
                        });
                    }
                }, //end success
