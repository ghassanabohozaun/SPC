...
@endsection
@section('content')
    <form class="form" action="{{ route('admin.books.store') }}" method="POST" id="form_book_store"
                        ...
                        <div class="card card-custom" id="card_languages">
                            <div class="card-body">
                                ...
                                <div class="tab-content mt-5">
                                    @include('admin.books.create_tabs.settings')
                                    @include('admin.books.create_tabs.details_en')
                                    @include('admin.books.create_tabs.details_ar')
                                </div>
                            </div>
                        </div>
                        <!--end::Card-->
...
@push('js')
    <script type="text/javascript">
        $('#form_book_store').on('submit', function(e) {
            e.preventDefault();
