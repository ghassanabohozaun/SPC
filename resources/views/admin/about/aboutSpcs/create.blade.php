...
@endsection
@section('content')
    <form class="form" action="{{ route('admin.about.spc.store') }}" method="POST" id="about_spc_store_from"
                        ...
                        <div class="card card-custom" id="card_languages">
                            <div class="card-body">
                                ...
                                <div class="tab-content mt-5">
                                    @include('admin.about.aboutSpcs.create_tabs.details_en')
                                    @if (setting()->site_lang_ar == 'on')
                                        @include('admin.about.aboutSpcs.create_tabs.details_ar')
                                    @endif
                                </div>
...
@push('js')
    <script type="text/javascript">
        $('#about_spc_store_from').on('submit', function(e) {
            e.preventDefault();
            ////////////////////////////////////////////////////////////////////
            $('#title_en_error').text('');
            $('#title_ar_error').text('');
