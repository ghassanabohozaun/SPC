...
@section('content')
    ...
    <form class="form" action="{{route('admin.team.member.update')}}" method="POST" id="form_team_member_update">
        @csrf
        <!--begin::Subheader-->
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                     style="background-image: url({{asset('adminBoard/uploadedImages/teams/'.$team->photo)}})"></div>
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        Swal.fire({
                            ...
                            customClass: {confirmButton: 'update_team_member_button'}
                        });
                        $('.update_team_member_button').click(function () {
