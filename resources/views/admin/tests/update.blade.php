...
@section('content')
    <form class="form" action="{{ route('admin.tests.update') }}" method="POST" id="test_update_form">
        @csrf
        <!--begin::Subheader-->
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="image-input image-input-outline" id="kt_test_photo">
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                    style="background-image: url({{ asset('adminBoard/uploadedImages/tests/' . $test->test_photo) }})">
                                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control form-control-solid form-control-lg"
                                                                ...
                                                                autocomplete="off" value="{{ $test->test_name }}" />
...
@push('js')
    <script type="text/javascript">
        ...
        $('#test_update_form').on('submit', function(e) {
            e.preventDefault();
            //////////////////////////////////////////////////////////////
                ...
                success: function(data) {
                    ...
                    if (data.status == true) {
                        Swal.fire({
                            ...
                            customClass: {
                                confirmButton: 'update_test_button'
                            }
                        });
