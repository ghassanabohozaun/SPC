    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div
            ...
            <div class="d-flex align-items-center">
                <a href="{!! route('admin.report.trashed') !!}"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="cst-switch switch-sm">
                                                                    <input type="checkbox"
                                                                           {{$report->status == 'on' ? 'checked':''}}  data-id="{{$report->id}}"
                                                                           class="change_status">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="#"
                                                                   class="btn btn-hover-danger btn-icon btn-pill delete_report_btn"
                                                                   data-id="{{$report->id}}"
        ...
        $(document).on('click', '.delete_report_btn', function (e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    // Delete User
                    $.ajax({
                        url: '{!! route('admin.report.destroy') !!}',
                        data: {id, id},
                        type: 'post',
                        dataType: 'json',
