...
@section('content')
    <form class="form" action="{{ route('admin.trainings.store') }}" method="POST" id="add_training_form">
        @csrf
        <!--begin::Subheader-->
                                            ...
                                            <div class="col-xl-9">
                                                ...
                                                <div class="my-5">
                                                    ...
                                                    <div class="form-group row d-none">
                                                        <input type="text" class="form-control" id="site_lang_ar"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control form-control-solid form-control-lg"
                                                                name="title_en" id="title_en" type="title_en"
                ...
                success: function(data) {
                    ...
                    if (data.status == true) {
                        Swal.fire({
                            ...
                            customClass: {
                                confirmButton: 'add_training_button'
                            }
                        });
