...
@section('content')
    ...
    <form class="form" action="{{route('admin.about.store')}}" method="POST" id="form_about_store"
                        ...
                        <div class="card card-custom" id="card_languages">
                            <div class="card-body">
                                ...
                                <div class="tab-content mt-5">
                                    @include('admin.abouts.create_tabs.settings')
                                    @include('admin.abouts.create_tabs.details_ar')
                                    @if($lang_en =setting()->site_lang_en == 'on')
                                    @include('admin.abouts.create_tabs.details_en')
                                    @endif
                                </div>
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        Swal.fire({
                            ...
                            customClass: {confirmButton: 'add_about_button'}
                        });
                        $('.add_about_button').click(function () {
                        ...
                        Swal.fire({
                            ...
                            icon: "error",
                            allowOutsideClick: false,
                            customClass: {confirmButton: 'error_about_button'}
                        });
                        $('.error_about_button').click(function () {
