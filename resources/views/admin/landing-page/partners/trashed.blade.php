        ...
        <div
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        <a href="#" class="text-muted">
                            {{__('menu.trashed_partners')}}
                        </a>
                    </li>

                    <li class="breadcrumb-item">
                        <a href="{{route('admin.partner.trashed')}}" class="text-muted">
                            {{__('menu.show_all')}}
                        </a>
                    </li>
                </ul>
                                                ...
                                                <table class="table myTable table-hover" id="myTable">
                                                    ...
                                                    @forelse($partners as $partner)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="btn btn-hover-warning btn-icon btn-pill restore_partner_btn"
                                                                   data-id="{{$partner->id}}"
                                                                ...
                                                                <a href="#"
                                                                   class="btn btn-hover-danger btn-icon btn-pill force_delete_partner_btn"
                                                                   data-id="{{$partner->id}}"
...
@push('js')
    <script type="text/javascript">
        ...
        // delete partner
        $(document).on('click', '.force_delete_partner_btn', function (e) {
            e.preventDefault();
            var id = $(this).data('id');
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    // Delete User
                    $.ajax({
                        url: '{!! route('admin.partner.force.delete') !!}',
                        data: {id, id},
                        type: 'post',
                        dataType: 'json',
                        success: function (data) {
                            ...
                            if (data.status == true) {
                                Swal.fire({
                                    ...
                                    icon: "success",
                                    allowOutsideClick: false,
                                    customClass: {confirmButton: 'delete_partner_button'}
                                });
                                $('.delete_partner_button').click(function () {
                    ...
                    Swal.fire({
                        ...
                        icon: "error",
                        allowOutsideClick: false,
                        customClass: {confirmButton: 'cancel_delete_partner_button'}
                    })
                }
            });
        })
        ...
        // restore partner
        $(document).on('click', '.restore_partner_btn', function (e) {
            e.preventDefault();
            var id = $(this).data('id');

            $.ajax({
                url: "{{route('admin.partner.restore')}}",
                data: {id, id},
                type: 'post',
                dataType: 'JSON',
                beforeSend: function () {
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        Swal.fire({
                            ...
                            icon: "success",
                            allowOutsideClick: false,
                            customClass: {confirmButton: 'restore_partner_button'}
                        });
                        $('.restore_partner_button').click(function () {
                            $('#myTable').load(location.href + (' #myTable'));
                        });
                    }
                },//end success
